...
RGB_MATRIX_EFFECT(TYPING_HEATMAP_MIN)
#    ifdef RGB_MATRIX_CUSTOM_EFFECT_IMPLS


#        ifndef RGB_MATRIX_TYPING_HEATMAP_MIN_BRIGHTNESS
#            define RGB_MATRIX_TYPING_HEATMAP_MIN_BRIGHTNESS 50
#        endif
...
#        endif
void process_rgb_matrix_typing_heatmap_min(uint8_t row, uint8_t col) {
...
bool TYPING_HEATMAP_MIN(effect_params_t* params) {
